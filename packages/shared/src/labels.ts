...
export const FIELD_LABELS: Record<string, string> = {
  ...
  nextMotorcycleStatus: 'destino da moto',
  depositOutcome: 'destino da caução',
  depositRetainedAmount: 'valor retido da caução',
  ...
  dataBase64: 'arquivo',
  visibleToCustomer: 'visível ao cliente',
  customerId: 'cliente',
  motorcycleId: 'moto',
  contractId: 'contrato',
